...
if platform == "linux" or platform == "linux2":
    data_dir = '/projects/prjs1945/data/classification'
else:
...
def run(config):
    ...
    checkpoint_callback = pl.callbacks.ModelCheckpoint(dirpath=config['checkpoint_folder_save'], monitor='val_f1', mode = 'max')
